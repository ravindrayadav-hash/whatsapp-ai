import { SummarizeResult, ExplainResult, ReplyResult, JiraResult } from './ResultCards.jsx';
        ...
        <div style={{ flex: 1, minWidth: 0, marginRight: 8 }}>
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: 8 }}>
            {selectedMsg.image_url && (
              <a href={selectedMsg.image_url} target="_blank" rel="noreferrer" style={{ flexShrink: 0 }}>
                <img
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <p style={{
                fontSize: 12, lineHeight: 1.5, color: 'var(--text-muted)', margin: 0,
          ...
          <div style={{ fontSize: 11, color: 'var(--text-muted)', marginTop: 6 }}>
            Using {contextMessages.length} message{contextMessages.length !== 1 ? 's' : ''} as context
          </div>
        </div>
        <button
          onClick={closePanel}
            ...
            >
              {loading && (
                <span style={{
                  ...
                  border: '1.5px solid var(--border)', borderTopColor: t.color,
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: 16 }}>
        ...
        {!isLoading && !currentResult && (
          <div style={{
            ...
            <button
              className="btn"
              style={{ background: tabCfg?.color, borderColor: tabCfg?.color, color: '#fff' }}
              onClick={() => runTab(selectedMsg, activeTab)}
            >
              Run {tabCfg?.label}
            </button>
