...
export const SELECTORS = {
  ...
  SEARCH_INPUT:     'input[aria-label="Search or start a new chat"], input[placeholder="Search or start a new chat"], [data-testid="chat-list-search"]',
  ...
  USE_HERE_BTN:     'button[aria-label="Use here"], div[role="button"]:has-text("Use here")',
  ...
  MSG_IMAGE: '[data-testid="image-thumb"] img, [data-testid="media-url-provider"] img, [data-testid="msg-image"] img',
  ...
  CONV_HEADER:      '#main header span[title]:not([aria-label]), [data-testid="conversation-info-header-chat-title"]',
  ...
  HISTORY_LOADING:  '[data-testid="media-upload-progress"], [aria-label="Loading"], [data-testid="tail"]',
};
